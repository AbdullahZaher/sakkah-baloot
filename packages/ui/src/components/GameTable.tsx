...
const styles = StyleSheet.create({
  ...
  trick: { flexDirection: "row", flexWrap: "wrap", width: 180, justifyContent: "center", gap: 6, marginTop: 12 }, trickCard: { alignItems: "center", gap: 2 }, trickSeat: { color: "#BFD2C9", fontSize: 8 }, waiting: { color: "#BFD2C9", fontSize: 11, marginTop: 10 }, result: { marginTop: 10, minWidth: 250, padding: 14, borderRadius: 14, backgroundColor: "#0D2C24", borderWidth: 1, borderColor: "#B89455", gap: 4 }, resultTitle: { color: "#F5E6BF", fontSize: 16, fontWeight: "800" }, resultLine: { color: "#E8F0EC", fontSize: 11 }, badge: { color: "#E8C66A", fontSize: 11, fontWeight: "800" }, matchLine: { color: "#BFD2C9", fontSize: 11, fontWeight: "700" },
});
